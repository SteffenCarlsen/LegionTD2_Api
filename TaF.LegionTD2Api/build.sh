...
${nuget_cmd} install src/TaF.LegionTD2Api/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/TaF.LegionTD2Api.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/TaF.LegionTD2Api.dll \
-recurse:'src/TaF.LegionTD2Api/*.cs' \
-doc:bin/TaF.LegionTD2Api.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/TaF.LegionTD2Api.dll was created successfully"
fi
