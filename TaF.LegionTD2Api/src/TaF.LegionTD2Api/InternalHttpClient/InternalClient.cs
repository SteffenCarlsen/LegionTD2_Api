...
namespace TaF.LegionTD2Api.InternalHttpClient
{
    public partial class InternalClient
    {
        ...
        {
            if (endpoint == null) throw new ArgumentException("You must supply a valid endpoint", nameof(endpoint));

            if (string.IsNullOrEmpty(endpoint)) throw new InvalidUrlException();
