...
namespace TaF.LegionTD2Api.Model
{
    ...
    public class Legion : IEquatable<Legion>, IValidatableObject
    {
        ...
        public Legion(string id = default, string name = default, string category = default, string iconPath = default,
            bool playable = default)
        {
        ...
        public bool Equals(Legion input)
        {
            ...
            return
                ...
                (
                    ...
                    (Playable != null &&
                     Playable.Equals(input.Playable))
                );
        }
