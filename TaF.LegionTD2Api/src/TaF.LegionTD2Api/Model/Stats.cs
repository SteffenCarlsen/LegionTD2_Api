    ...
    public class Stats : IEquatable<Stats>, IValidatableObject
    {
        ...
        public bool Equals(Stats input)
        {
            ...
            return
                ...
                (
                    SecondsPlayed == input.SecondsPlayed ||
                    (SecondsPlayed.Equals(input.SecondsPlayed))
                ) &&
                (
                    GamesPlayed == input.GamesPlayed ||
                    (GamesPlayed.Equals(input.GamesPlayed))
                ) &&
                (
                    TotalXp == input.TotalXp ||
                    (TotalXp.Equals(input.TotalXp))
                ) &&
                (
                    ___ == input.___ ||
                    (___ != null &&
                     ___.Equals(input.___))
                );
        }
