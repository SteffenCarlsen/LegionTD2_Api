...
namespace TaF.LegionTD2Api.Model
{
    ...
    public class Ability : IEquatable<Ability>, IValidatableObject
    {
        ...
        public Ability(string id = default, string name = default, int aoeRange = default, string tooltip = default,
            string duration = default, string iconPath = default, string category = default,
            string description = default, string bounces = default, string baseDamage = default,
            string cooldown = default, string descriptionId = default)
        {
        ...
        public bool Equals(Ability input)
        {
            ...
            return
                ...
                (
                    AoeRange == input.AoeRange ||
                    (AoeRange != null &&
                     AoeRange.Equals(input.AoeRange))
                ) &&
                (
                ...
                (
                    ...
                    (Cooldown != null &&
                     Cooldown.Equals(input.Cooldown))
                ) &&
                (
