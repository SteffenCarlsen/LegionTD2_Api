  ...
  public class PlayersData
    {
        ...
        [JsonProperty("classicElo")]
        public int? ClassicElo { get; set; }

        [JsonProperty("overallElo")]
        ...
        [JsonProperty("leaksPerWave")]
        public List<List<string>> LeaksPerWave { get; set; }

        [JsonProperty("buildPerWave")]
        public List<List<string>> BuildPerWave { get; set; }

        [JsonProperty("leakValue")]
        public int? LeakValue { get; set; }

        [JsonProperty("leaksCaughtValue")]
