...
/// </summary>
[DataContract]
public class Spell : IEquatable<Spell>, IValidatableObject
{
    /// <summary>
    ...
    public Spell(string id = default, string name = default, string category = default, string tooltip = default, string iconPath = default, bool enabled = default)
    {
        // to ensure "name" is required (not null)
        if (name == null)
        {
            throw new InvalidDataException("name is a required property for Spell and cannot be null");
        }
    ...
    /// <summary>
    ///     Returns true if Spell instances are equal
    /// </summary>
    /// <param name="input">Instance of Spell to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(Spell input)
    {
        if (input == null)
        {
            return false;
        ...
        return (Id == input.Id || (Id != null && Id.Equals(input.Id))) && (Name == input.Name || (Name != null && Name.Equals(input.Name))) && (Category == input.Category || (Category != null && Category.Equals(input.Category))) && (Tooltip == input.Tooltip || (Tooltip != null && Tooltip.Equals(input.Tooltip))) && (IconPath == input.IconPath || (IconPath != null && IconPath.Equals(input.IconPath))) && (Enabled == input.Enabled || (Enabled != null && Enabled.Equals(input.Enabled)));
    }
