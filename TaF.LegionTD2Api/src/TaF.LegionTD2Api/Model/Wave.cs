...
namespace TaF.LegionTD2Api.Model
{
    ...
    public class Wave : IEquatable<Wave>, IValidatableObject
    {
        ...
        public Wave(string id = default, string name = default, string waveUnitId = default, string amount = default,
            string amount2 = default, string category = default, string spellUnit2Id = default,
            string iconPath = default, string levelNum = default, string prepareTime = default,
            string totalReward = default)
        {
        ...
        public bool Equals(Wave input)
        {
            ...
            return
                ...
                (
                    WaveUnitId == input.WaveUnitId ||
                    (WaveUnitId != null &&
                     WaveUnitId.Equals(input.WaveUnitId))
                ) &&
                (
                    Amount == input.Amount ||
                    (Amount != null &&
                ...
                (
                    SpellUnit2Id == input.SpellUnit2Id ||
                    (SpellUnit2Id != null &&
                     SpellUnit2Id.Equals(input.SpellUnit2Id))
                ) &&
                (
                ...
                (
                    LevelNum == input.LevelNum ||
                    (LevelNum != null &&
                     LevelNum.Equals(input.LevelNum))
                ) &&
                (
                    PrepareTime == input.PrepareTime ||
                    (PrepareTime != null &&
                     PrepareTime.Equals(input.PrepareTime))
                ) &&
                (
                    TotalReward == input.TotalReward ||
                    (TotalReward != null &&
                     TotalReward.Equals(input.TotalReward))
                );
        }
