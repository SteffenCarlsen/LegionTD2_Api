...
public class PlayerMatchdetails : IEquatable<PlayerMatchdetails>, IValidatableObject
{
    ...
    public PlayerMatchdetails(string playerId = default, string playerName = default, int playerSlot = default, string legion = default, int workers = default, int value = default, bool cross = default, string gameResult = default, int overallElo = default, int classicElo = default, string fighters = default, string mercenaries = default, bool stayedUntilEnd = default, string chosenSpell = default, string chosenSpellLocation = default, int partySize = default, string firstWaveFighters = default, string rolls = default, bool eco = default, int legionSpecificElo = default, List<string> partyMembers = default, List<string> partyMembersId = default, int mvpScore = default, List<int> netWorthPerWave = default, List<double> workersPerWave = default, List<int> incomePerWave = default, List<string> mercenariesSentPerWave = default, List<string> mercenariesReceivedPerWave = default, List<string> leaksPerWave = default, List<string> buildPerWave = default, int leakValue = default, int leaksCaughtValue = default, double leftAtSeconds = default, List<string> kingUpgradesPerWave = default, List<string> receivedKingUpgradesPerWave = default)
    {
        PlayerId = playerId;
    ...
    public bool Equals(PlayerMatchdetails input)
    {
        ...
        return (PlayerId == input.PlayerId || (PlayerId != null && PlayerId.Equals(input.PlayerId))) && (PlayerName == input.PlayerName || (PlayerName != null && PlayerName.Equals(input.PlayerName))) && (PlayerSlot == input.PlayerSlot || (PlayerSlot != null && PlayerSlot.Equals(input.PlayerSlot))) && (Legion == input.Legion || (Legion != null && Legion.Equals(input.Legion))) && (Workers == input.Workers || (Workers != null && Workers.Equals(input.Workers))) && (Value == input.Value || (Value != null && Value.Equals(input.Value))) && (Cross == input.Cross || (Cross != null && Cross.Equals(input.Cross))) && (GameResult == input.GameResult || (GameResult != null && GameResult.Equals(input.GameResult))) && (OverallElo == input.OverallElo || (OverallElo != null && OverallElo.Equals(input.OverallElo))) && (ClassicElo == input.ClassicElo || (ClassicElo != null && ClassicElo.Equals(input.ClassicElo))) && (Fighters == input.Fighters || (Fighters != null && Fighters.Equals(input.Fighters))) && (Mercenaries == input.Mercenaries || (Mercenaries != null && Mercenaries.Equals(input.Mercenaries))) && (StayedUntilEnd == input.StayedUntilEnd || (StayedUntilEnd != null && StayedUntilEnd.Equals(input.StayedUntilEnd))) && (ChosenSpell == input.ChosenSpell || (ChosenSpell != null && ChosenSpell.Equals(input.ChosenSpell))) && (ChosenSpellLocation == input.ChosenSpellLocation || (ChosenSpellLocation != null && ChosenSpellLocation.Equals(input.ChosenSpellLocation))) && (PartySize == input.PartySize || (PartySize != null && PartySize.Equals(input.PartySize))) && (FirstWaveFighters == input.FirstWaveFighters || (FirstWaveFighters != null && FirstWaveFighters.Equals(input.FirstWaveFighters))) && (Rolls == input.Rolls || (Rolls != null && Rolls.Equals(input.Rolls))) && (Eco == input.Eco || (Eco != null && Eco.Equals(input.Eco))) && (LegionSpecificElo == input.LegionSpecificElo || (LegionSpecificElo != null && LegionSpecificElo.Equals(input.LegionSpecificElo))) && (PartyMembers == input.PartyMembers || (PartyMembers != null && input.PartyMembers != null && PartyMembers.SequenceEqual(input.PartyMembers))) && (PartyMembersId == input.PartyMembersId || (PartyMembersId != null && input.PartyMembersId != null && PartyMembersId.SequenceEqual(input.PartyMembersId))) && (MvpScore == input.MvpScore || (MvpScore != null && MvpScore.Equals(input.MvpScore))) && (NetWorthPerWave == input.NetWorthPerWave || (NetWorthPerWave != null && input.NetWorthPerWave != null && NetWorthPerWave.SequenceEqual(input.NetWorthPerWave))) && (WorkersPerWave == input.WorkersPerWave || (WorkersPerWave != null && input.WorkersPerWave != null && WorkersPerWave.SequenceEqual(input.WorkersPerWave))) && (IncomePerWave == input.IncomePerWave || (IncomePerWave != null && input.IncomePerWave != null && IncomePerWave.SequenceEqual(input.IncomePerWave))) && (MercenariesSentPerWave == input.MercenariesSentPerWave || (MercenariesSentPerWave != null && input.MercenariesSentPerWave != null && MercenariesSentPerWave.SequenceEqual(input.MercenariesSentPerWave))) && (MercenariesReceivedPerWave == input.MercenariesReceivedPerWave || (MercenariesReceivedPerWave != null && input.MercenariesReceivedPerWave != null && MercenariesReceivedPerWave.SequenceEqual(input.MercenariesReceivedPerWave))) && (LeaksPerWave == input.LeaksPerWave || (LeaksPerWave != null && input.LeaksPerWave != null && LeaksPerWave.SequenceEqual(input.LeaksPerWave))) && (BuildPerWave == input.BuildPerWave || (BuildPerWave != null && input.BuildPerWave != null && BuildPerWave.SequenceEqual(input.BuildPerWave))) && (LeakValue == input.LeakValue || (LeakValue != null && LeakValue.Equals(input.LeakValue))) && (LeaksCaughtValue == input.LeaksCaughtValue || (LeaksCaughtValue != null && LeaksCaughtValue.Equals(input.LeaksCaughtValue))) && (LeftAtSeconds == input.LeftAtSeconds || (LeftAtSeconds != null && LeftAtSeconds.Equals(input.LeftAtSeconds))) && (KingUpgradesPerWave == input.KingUpgradesPerWave || (KingUpgradesPerWave != null && input.KingUpgradesPerWave != null && KingUpgradesPerWave.SequenceEqual(input.KingUpgradesPerWave))) && (ReceivedKingUpgradesPerWave == input.ReceivedKingUpgradesPerWave || (ReceivedKingUpgradesPerWave != null && input.ReceivedKingUpgradesPerWave != null && ReceivedKingUpgradesPerWave.SequenceEqual(input.ReceivedKingUpgradesPerWave)));
    }
