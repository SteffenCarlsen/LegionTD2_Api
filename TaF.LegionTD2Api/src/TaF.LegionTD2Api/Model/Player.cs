...
namespace TaF.LegionTD2Api.Model
{
    ...
    public class Player : IEquatable<Player>, IValidatableObject
    {
        ...
        public Player(string id = default, string name = default, string avatarUrl = default, string guildTag = default,
            string guildName = default, string guildAvatar = default)
        {
        ...
        public bool Equals(Player input)
        {
            ...
            return
                ...
                (
                    ...
                    (GuildTag != null &&
                     GuildTag.Equals(input.GuildTag))
                ) &&
                (
                    GuildName == input.GuildName ||
                    (GuildName != null &&
                     GuildName.Equals(input.GuildName))
                ) &&
                (
                    GuildAvatar == input.GuildAvatar ||
                    (GuildAvatar != null &&
                     GuildAvatar.Equals(input.GuildAvatar))
                );
        }
