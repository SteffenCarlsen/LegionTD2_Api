...
public class Match : IEquatable<Match>, IValidatableObject
{
    ...
    [JsonProperty("endingWave")] public int? EndingWave { get; set; }

    [JsonProperty("gameLength")] public int? GameLength { get; set; }

    [JsonProperty("gameElo")] public int? GameElo { get; set; }

    [JsonProperty("playerCount")] public int? PlayerCount { get; set; }

    [JsonProperty("humanCount")] public int? HumanCount { get; set; }

    [JsonProperty("spellChoices")] public List<string> SpellChoices { get; set; }

    [JsonProperty("leftKingPercentHp")] public List<double?> LeftKingPercentHp { get; set; }

    [JsonProperty("rightKingPercentHp")] public List<double?> RightKingPercentHp { get; set; }

    [JsonProperty("kingSpell")] public string KingSpell { get; set; }

    [JsonProperty("playersData")] public List<PlayersData> PlayersData { get; set; }
    ...
    public bool Equals(Match input)
    {
        ...
        return (Id == input.Id || (Id != null && Id.Equals(input.Id))) && (Version == input.Version || (Version != null && Version.Equals(input.Version))) && (Date == input.Date || (Date != null && Date.Equals(input.Date))) && (QueueType == input.QueueType || (QueueType != null && QueueType.Equals(input.QueueType))) && (EndingWave == input.EndingWave || (EndingWave != null && EndingWave.Equals(input.EndingWave))) && (GameElo == input.GameElo || (GameElo != null && GameElo.Equals(input.GameElo))) && (PlayerCount == input.PlayerCount || (PlayerCount != null && PlayerCount.Equals(input.PlayerCount))) && (HumanCount == input.HumanCount || (HumanCount != null && HumanCount.Equals(input.HumanCount))) && (LeftKingPercentHp == input.LeftKingPercentHp || (LeftKingPercentHp != null && input.LeftKingPercentHp != null && LeftKingPercentHp.SequenceEqual(input.LeftKingPercentHp))) && (RightKingPercentHp == input.RightKingPercentHp || (RightKingPercentHp != null && input.RightKingPercentHp != null && RightKingPercentHp.SequenceEqual(input.RightKingPercentHp))) && (GameLength == input.GameLength || (GameLength != null && GameLength.Equals(input.GameLength))) && (SpellChoices == input.SpellChoices || (SpellChoices != null && input.SpellChoices != null && SpellChoices.SequenceEqual(input.SpellChoices))) && (KingSpell == input.KingSpell || (KingSpell != null && KingSpell.Equals(input.KingSpell))) && (PlayersData == input.PlayersData || (PlayersData != null && input.PlayersData != null && PlayersData.SequenceEqual(input.PlayersData)));
    }
